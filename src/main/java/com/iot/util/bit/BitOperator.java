...
public class BitOperator {
    ...
    public String fourByteToBit(byte[] value) {
        String temp0 = String.format("%8s", Integer.toBinaryString(oneByteToInteger(value[0]))).replace(' ', '0');
        String temp1 = String.format("%8s", Integer.toBinaryString(oneByteToInteger(value[1]))).replace(' ', '0');
        String temp2 = String.format("%8s", Integer.toBinaryString(oneByteToInteger(value[2]))).replace(' ', '0');
        String temp3 = String.format("%8s", Integer.toBinaryString(oneByteToInteger(value[3]))).replace(' ', '0');
    ...
    public int getCheckSum4JT808(byte[] bs, int start, int end) {
        if (start < 0 || end > bs.length)
            throw new ArrayIndexOutOfBoundsException("getCheckSum4JT808 error : index out of bounds(verifyStatus=" + start
    ...
    public int getBitRange(int number, int start, int end) {
        if (start < 0)
            throw new IndexOutOfBoundsException("min index is 0,but verifyStatus = " + start);
        if (end >= Integer.SIZE)
